#!/usr/bin/env bash
set -euo pipefail
timestamp=20260910-0944
log_dir_full=/Users/edburns/workareas/dd-3061974-02-cargotracker-shepherd-control/1-arrival-deadline-control-remove-before-merge/prompts/shepherd-task-20-20260910-0944
...
prompt_file=/Users/edburns/workareas/dd-3061974-02-cargotracker-shepherd-control/1-arrival-deadline-control-remove-before-merge/prompts/shepherd-task-20-20260910-0944/20260910-0944-invoke-shepherd-task-20-create-issues-from-plan-skill.md
